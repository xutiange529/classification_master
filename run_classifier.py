...
class TnewsProcessor(DataProcessor):
    ...
    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_excel(os.path.join(data_dir, "test.xlsx")), "test")

    def get_labels(self):
        """See base class."""
        with open(os.path.join(FLAGS.data_dir, 'label.txt'), 'r', encoding='gbk') as f:
